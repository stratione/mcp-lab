...
echo ""
echo "  The dashboard opens automatically on first visit and shows"
echo "  all service links, API docs, and the learning progression."
echo ""
echo "  MCP servers start OFF. Enable them one at a time:"
echo ""
...
echo ""
echo "  Restart lab after code changes:  ./scripts/2-restart-lab.sh"
echo "  Open API docs in browser:        ./scripts/3-open-api-docs.sh"
echo "  Show this reference again:       ./scripts/4-help.sh"
echo ""
echo "========================================================"
echo ""
