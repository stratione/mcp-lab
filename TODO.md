...
- [x] MCP server start/stop controls in the Chat UI — optional `ENABLE_MCP_CONTROLS=true` flag adds Start/Stop buttons to the MCP status modal; uses Docker socket (no CLI terminal, no arbitrary commands; allowlisted to the 4 known MCP services)
